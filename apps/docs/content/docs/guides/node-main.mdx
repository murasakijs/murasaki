...
windows are managed from trusted renderers through `murasaki/native`. Main also
does not yet provide tray-menu or global-shortcut APIs. Packaged macOS/Windows single-instance delivery is available
