...
convention. See [Node Main](/docs/guides/node-main).
...
<Cards>
  ...
  <Card title="Node Main" href="/docs/guides/node-main" description="Long-lived backend state and typed renderer calls." />
