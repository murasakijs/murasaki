import { Link, UpdateButton } from 'murasaki'
...
export default function Page() {
  return (
    <main className="mx-auto max-w-2xl text-center">
      ...
      {/* Auto-updater: renders nothing when up to date, and a button when a
          newer signed release is available (checked on launch via updater:true). */}
      <div className="mt-8 flex flex-col items-center gap-2">
        <span className="text-xs uppercase tracking-wider text-muted-foreground/60">Updater</span>
        <UpdateButton />
      </div>
