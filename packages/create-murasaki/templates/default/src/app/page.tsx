 ...
 *
 * Right-click anywhere for a native OS context menu (NSMenu on macOS, HMENU on
 * Windows, GtkMenu on Linux). You write it like shadcn's <ContextMenu>, but
 * murasaki pops the real OS menu — no HTML popup.
 */
